							...
							<tr>
								<th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    <button class="flex items-center uppercase hover:underline" wire:click="sortBy('title')">
                                        ...
                                        @if ($sortField === 'title')
                                            {{-- - {{$sortDirection}} --}}
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 ml-1 duration-200 @if($sortDirection === 'desc' ) rotate-180 @endif" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex justify-between items-center">
                                                ...
                                                <livewire:article-delete-modal :article="$article" wire:key="{{'article-delete-button-'.$article->id}}">
